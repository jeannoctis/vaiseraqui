            ...
            options.template = '<div class="daterangepicker dropdown-menu">' +
                '<div class="calendar left">' +
                    '<div class="daterangepicker_input">' +
                      ...
                      '<i class="fab fa-calendar glyphicon glyphicon-calendar"></i>' +
                ...
                '<div class="calendar right">' +
                    '<div class="daterangepicker_input">' +
                      ...
                      '<div class="calendar-time">' +
                        '<div></div>' +
                        '<i class="fab fa-clock-o glyphicon glyphicon-time"></i>' +
                      '</div>' +
                    '</div>' +
                    '<div class="calendar-table"></div>' +
                '</div>' +
                '<div class="ranges">' +
                    '<div class="range_inputs">' +
                        '<button class="applyBtn btn-primary" disabled="disabled" type="button"></button> ' +
                        '<button style="background-color:#CCC !important; color: #000;" class="cancelBtn btn-default" type="button"></button>' +
                    '</div>' +
                '</div>' +
            '</div>';
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            if ((!minDate || minDate.isBefore(calendar.firstDay)) && (!this.linkedCalendars || side == 'left')) {
                html += '<th class="prev available"><i class="fab fa-chevron-left glyphicon glyphicon-chevron-left"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if ((!maxDate || maxDate.isAfter(calendar.lastDay)) && (!this.linkedCalendars || side == 'right' || this.singleDatePicker)) {
                html += '<th class="next available"><i class="fab fa-chevron-right glyphicon glyphicon-chevron-right"></i></th>';
            } else {
                html += '<th></th>';
            }
