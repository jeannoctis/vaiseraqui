...
$('#campoTemporada').click(function (e) {
  var isChecked = document.getElementById("campoTemporada").checked;
  document.getElementById("selectTemporada").disabled = !isChecked;
  document.getElementById("selectTemporada").selectedIndex = 0;
});
$('#campoHospedagem').click(function (e) {
  var isChecked = document.getElementById("campoHospedagem").checked;
  document.getElementById("selectHospedagem").disabled = !isChecked;
  document.getElementById("selectHospedagem").selectedIndex = 0;
});
$('#campoEventos').click(function (e) {
  var isChecked = document.getElementById("campoEventos").checked;
  document.getElementById("selectEventos").disabled = !isChecked;
  document.getElementById("selectEventos").selectedIndex = 0;
});
$('#campoSaloes').click(function (e) {
  var isChecked = document.getElementById("campoSaloes").checked;
  document.getElementById("selectSaloes").disabled = !isChecked;
  document.getElementById("selectSaloes").selectedIndex = 0;
});
$('#campoTemporarias').click(function (e) {
  var isChecked = document.getElementById("campoTemporarias").checked;
  document.getElementById("selectTemporarias").disabled = !isChecked;
  document.getElementById("selectTemporarias").selectedIndex = 0;
});
$('#campoServicos').click(function (e) {
  var isChecked = document.getElementById("campoServicos").checked;
  document.getElementById("selectServicos").disabled = !isChecked;
  document.getElementById("selectServicos").selectedIndex = 0;
});
