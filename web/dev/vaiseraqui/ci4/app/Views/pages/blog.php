...
<body class="blog-list-categories">
  <header class="header">
    <div class="container">
  ...
  <main>  
    ...
    <header class="header-page" data-aos="fade-up">
      <div class="container-medium">
        <h1>Inspirações</h1>
        <a href="./blog-listagem.html" class="goback">
        ...
        <div class="list">
          <article class="post-article" data-aos="fade-up">
            <a href="#">
              ...
              <div class="info">
                <h3>Buffet em domicílio ou fixo, qual a melhor opção?</h3>
                <p>Hoje, além dos buffets fixos, há uma quantidade enorme de opções para realizar festas, chácaras, salões de festas ou eventos, salões de condomínios, a própria casa, parques, shoppings, paintball, quadra de futebol, etc...</p>
                <a href="#" class="more">
                  Ler artigo
                  <svg width="6" height="11" viewBox="0 0 6 11" fill="none" xmlns="http://www.w3.org/2000/svg">
