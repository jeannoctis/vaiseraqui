   ...
   <section class="s-text-and-slider">
      ...
      <div class="slider" data-aos="fade-left">
         <div class="top">
            ...
            <a href="#" class="like <?= (in_array($lojaAtual->id, $todosFavoritos)) ? 'active' : '' ?>" onclick="favoritar(<?= $lojaAtual->id ?>)" data-id-heart="<?= $lojaAtual->id ?>">
         ...
         <div class="column">
            <div class="sticky">
               <aside class="box">
                  ...
                  <a href="<?=$anunciante->whatsapp?>&text=Olá, vim pelo site vaiseraqui.com.br e tenho interesse no anúncio: <?=$metatag->titulo?>" class="btn-primary">
