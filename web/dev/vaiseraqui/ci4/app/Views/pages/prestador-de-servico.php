                    ...
                    <aside class="service-providers">
                        <form action="#">
                            <div class="input-group">
                                <label for="mobile-table-checkin">Data do Evento</label>
                            ...
                            <div style='display: none; margin-top: 15px;' id='maisDeUmDia2' class="input-group">
                                <label for="mobile-table-checkout">Data final do Evento</label>
            ...
            <div class="column">
                <div class="sticky">
                    <aside class="service-providers">
                        <form action="#">
                            <div class="input-group">
                                <label for="desktop-table-checkin">Data do Evento</label>
                            ...
                            <div style='display: none; margin-top: 15px;' id='maisDeUmDia' class="input-group">
                                <label for="desktop-table-checkout">Data final do Evento</label>
