            ...
            <aside class="service-providers">
              <form action="#">
                <div class="input-group">
                  ...
                  <input type="text" readonly="" name="" value="15/08/2023" id="mobile-table-checkin" class="hasDatepicker">                
                </div>
                <div class="checkbox">                  
                  <input type="checkbox" name="" id="checkbox-event">
                  ...
                  <div class="modal-order">
                    ...
                    <div class="modal-order-select">
                      <div class="wraper-scroll">
                        <div class="content">
                          <a href="#" class="active" data-select-value="Até 200 pessoas">Até 200 pessoas</a>
                          <a href="#" data-select-value="Até 300 pessoas">Até 300 pessoas</a>
                          <a href="#" data-select-value="Até 400 pessoas">Até 400 pessoas</a>
                          <a href="#" data-select-value="Até 500 pessoas">Até 500 pessoas</a>
                          <a href="#" data-select-value="Até 600 pessoas">Até 600 pessoas</a>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="sticky">
            <aside class="service-providers">
              <form action="#">
                <div class="input-group">
                  <label for="date-event">Data do Evento</label>
                  <input type="text" readonly name="" value="15/08/2023" id="desktop-table-checkin">                
                </div>
                <div class="checkbox">                  
                  <input type="checkbox" name="" id="checkbox-event">
                  <label for="checkbox-event">Evento de mais de 01 dia</label>
              ...
              <? if($responsavel) {
                  ?>
            <div class="box-ads">
              <img src="<?=PATHSITE?>assets/images/avatar-2.png" alt="">
              <div>
                <span class="type">Responsável pelo serviço</span>
