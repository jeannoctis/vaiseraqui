      ...
      <div class="container-medium">
        <div class="column">
          <nav class="navigation-breadcrumb" data-aos="fade-up">
            ...
            <a href="#">Recanto Remape</a>
          </nav>
          <aside class="info-slider" data-aos="fade-up">
            <div class="price">
              <span class="total">Total R$2.839</span>
              <span class="rent">Aluguel R$2.400</span>
            </div>
            <div class="buttons">              
              <a href="#">Ver mais detalhes</a>
            </div>
          ...
          <aside class="info-about-item" data-aos="fade-right">
            ...
            <div class="box-checkin">
              ...
              <table class="resume">
                <tbody><tr>
                  <td><span>R$97 x 5 diárias</span></td>
                  <td>R$485</td>
                </tr>
                <tr>
                  <td><span>Taxa de limpeza</span></td>
                  <td class="featured">Grátis</span></td>
                </tr>
              </tbody></table>
              <hr>
              <div class="total">
          ...
          <article data-aos="fade-right">
            ...
            <div class="list-li">
              ...
              <div class="wraper">
                <ul>
                  <li>15 mesas plásticas</li>
                  <li>60 pratos</li>
                  <li>Alarme</li>
                  <li>Banco(s) de madeira grande</li>
                  <li>Banheiro masculino</li>
                  <li>Cerca elétrica</li>
                  <li>Churrasqueira com balcão e pia</li>
                  <li>Espaço para fazer costela de chão</li>
                  
                </ul>
                <ul>
                  <li>60 cadeiras plásticas</li>
                  <li>60 jogos de talheres</li>
                  <li>Ampla área verde</li>
                  <li>Banheiro feminino</li>
                  <li>Banheiro para cadeirante</li>
                  <li>Cervejeira</li>
                  <li>Ducha na piscina</li>
                </ul>
              </div>
            </div>
        ...
        <div class="column">
          <div class="sticky">
            <aside class="box-checkin">
              ...
              <div class="table-checkin">
                <div class="tr">
                  <div class="td">
                    <strong>Check-in</strong>
                    <input readonly="" type="text" id="desktop-table-checkin" value="15/08/2024">
                  </div>
                  <div class="td">
                    <strong>Checkout</strong>
            ...
            <div class="box-ads">
              <img src="<?=PATHSITE?>assets/images/avatar-anunciante.png" alt="">
              <div>
                <span class="type">Anunciante</span>
                <span class="title">Genivaldo ou Rafael</span>
                <ul>
                  <li>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <article class="card-services">                                    
                ...
                ?>
                        <div class="swiper-slide">
                        <a data-fslightbox="gallery" href="<?=PATHSITE?>uploads/produto/<?=$foto->produtoFK?><?=$foto->arquivo?>">
                          <img src="<?=PATHSITE?>uploads/produto/<?=$foto->produtoFK?><?=$foto->arquivo?>" alt="">
                        </a>
                      </div>
            <? } } ?>    
