        ...
        <div class="column">
          ...
          <aside class="info-about-item" data-aos="fade-right">
            ...
            <div class="box-checkin">
              ...
              <a onclick="agendar('salao-de-festa','<?=encode($metatag->id)?>')" href="#" class="btn-primary">
                <img src="<?=PATHSITE?>assets/images/icon-whatsapp.svg" alt="">
                Agendar
              </a>
              <table class="resume">
                <tbody><tr>
                  <td><span><?=number_format($valores->preco,2,'.',',')?> x 1 diárias</span></td>
                  <td><?=number_format($valores->preco,2,'.',',')?></td>
                </tr>
                <tr>
        ...
        <div class="column">
          <div class="sticky">
            <aside class="box-checkin">
              ...
              <table class="resume">
                <tr>
                  <td><span><?=number_format($metatag->preco,2,',','.')?> x 1 diárias</span></td>
                  <td><?=number_format($metatag->preco,2,',','.')?></td>
                </tr>
                  <?
                  $soma = $metatag->preco;
                  if($valores) {
              ...
              <div class="total">
                <span>Total</span>
                <span><?=number_format($soma,2,',','.')?></span>
              </div>
            </aside>
              <? if($anunciante) {?>
            <div class="box-ads">
                  <img src="<?= PATHSITE ?>uploads/anunciante/<?= $anunciante->arquivo ?>" alt="foto do anunciante">
                  <div>
          ...
          <div class="swiper-wrapper">
            ...
            <? } } ?>    
                  ...
                  <div class="info">
                    ...
                    <a onclick="favoritar(<?=$destaque->id?>)" class="icon-heart">
