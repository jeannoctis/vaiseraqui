      ...
      <div class="info" data-aos="fade-right">
        ...
        <footer>
          ...
          <div class="buttons">
            ...
            <a onclick="abreWhatsapp('<?=encode($metatag->id)?>');" href="<?=$anunciante->whatsapp?>&text=Olá, vim pelo site vaiseraqui.com.br e tenho interesse no anúncio: <?=$metatag->titulo?>" class="btn-primary">
            ...
            <div class="box-checkin">
              ...
              <div class="table-checkin">
                ...
                <div class="tr">
                  ...
                  <? if($anunciante->whatsapp) {?> 
              <a onclick="abreWhatsapp('<?=encode($metatag->id)?>'); agendar('salao-de-festa','<?= PATHSITE . 'salao-de-festa-e-area-de-lazer/' . $metatag->identificador .'/' ?>', '<?=$anunciante->whatsapp?>','mobile');" href="#" class="btn-primary">
          ...
          <div class="sticky">
            <aside class="box-checkin">
              ...
              <div class="table-checkin">
                ...
                <? if($anunciante->whatsapp) {?>
              <a onclick="abreWhatsapp('<?=encode($metatag->id)?>'); agendar('salao-de-festa','<?= PATHSITE . 'salao-de-festa-e-area-de-lazer/' . $metatag->identificador .'/' ?>', '<?=$anunciante->whatsapp?>','desktop'); " class="btn-primary">
                <img src="<?=PATHSITE?>assets/images/icon-whatsapp.svg" alt="">
                Agendar
              </a>
                <? } ?>
