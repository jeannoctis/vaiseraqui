...
<form action="<?=PATHSITE?>eventos/" method="get"  class="form<?=$id?> <?= $form7Visible ?>  <?=$visivel?>">
    ...
    <input type="hidden"  name="ordem" value="<?= $get['ordem'] ?>" />
              ...
              <div class="input-group-wraper mb-10">              
                <div class="box-select j-box-select">
                  ...
                  <div class="select">
                    <input type="text" placeholder="Busque por categoria">
                    <div class="select-list">
              ...
              <button class="btn-primary" type="submit">Buscar2</button>
            </form>