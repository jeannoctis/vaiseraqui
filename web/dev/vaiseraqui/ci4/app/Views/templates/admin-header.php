...
<head>
   ...
   <link rel="shortcut icon" type="image/x-icon" href="<?= PATHSITE ?>assets/images/favicon.ico">
            ...
            <? if (in_array(3, $aprovados) || $adminMaster) { ?>
               <ul class="menu js__accordion">
                  <li class='<?= ($_SESSION["menuAdmin"] == 3) ? 'current active' : '' ?> '>
                     ...
                     <ul class="sub-menu js__content">                        
                        <li class='<?= ($segments[1] == 'texto' && decode($segments[3]) == 6) ? "linha-selected" : "" ?>'><a href="<?= PATHSITE ?>admin/texto/form/<?= encode(6) ?>">Blog</a></li>
                        <li class='<?= ($segments[1] == 'artigo') ? "linha-selected" : "" ?>'><a href="<?= PATHSITE ?>admin/artigo/"><i class="bi-caret-right-fill"></i> Artigos</a></li>
                        <li class='<?= ($segments[1] == 'bcategoria') ? "linha-selected" : "" ?>'><a href="<?= PATHSITE ?>admin/bcategoria/">Categorias</a></li>
                     </ul>
                  </li>
               </ul>
            <? } ?>
            ...
            <? if (in_array(4, $aprovados) || $adminMaster) { ?>
               <ul class="menu js__accordion">
                  <li class='<?= ($_SESSION["menuAdmin"] == 4) ? 'current active' : '' ?> '>
                     ...
                     <ul class="sub-menu js__content">
                        <li class='<?= ($segments[1] == 'projeto') ? "linha-selected" : "" ?>'><a href="<?= PATHSITE ?>admin/projeto/"><i class="bi-caret-right-fill"></i> Projetos</a></li>
                        <li class='<?= ($segments[1] == 'pavimento') ? "linha-selected" : "" ?>'><a href="<?= PATHSITE ?>admin/pavimento/"><i class="bi-caret-right-fill"></i> Pavimentos</a></li>
                        <li class='<?= ($segments[1] == 'texto' && decode($segments[3]) == 9) ? "linha-selected" : "" ?>'><a href="<?= PATHSITE ?>admin/texto/form/<?= encode(9) ?>">Texto PJ Recentes</a></li>
                        <li class='<?= ($segments[1] == 'texto' && decode($segments[3]) == 10) ? "linha-selected" : "" ?>'><a href="<?= PATHSITE ?>admin/texto/form/<?= encode(10) ?>">Texto PJ Relevantes</a></li>
                        <li class='<?= ($segments[1] == 'texto' && decode($segments[3]) == 11) ? "linha-selected" : "" ?>'><a href="<?= PATHSITE ?>admin/texto/form/<?= encode(11) ?>">Texto Outros PJ</a></li>
                        <li class='<?= ($segments[1] == 'texto' && decode($segments[3]) == 14) ? "linha-selected" : "" ?>'><a href="<?= PATHSITE ?>admin/texto/form/<?= encode(14) ?>">Texto Direitos Autorais</a></li>
                     </ul>
                  </li>
               </ul>
            <? } ?>
            ...
            <? if (in_array(5, $aprovados) || $adminMaster) { ?>
               <ul class="menu js__accordion">
                  <li class='<?= ($_SESSION["menuAdmin"] == 5) ? 'current active' : '' ?> '>
                     <a class="waves-effect parent-item js__control" href="#"><i class="menu-icon bi bi-box"></i><span>Pedidos</span><span class="menu-arrow fa fa-angle-down"></span></a>
                     <ul class="sub-menu js__content">
                        <li class='<?= ($segments[1] == 'pedido') ? "linha-selected" : "" ?>'><a href="<?= PATHSITE ?>admin/pedido/"><i class="bi-caret-right-fill"></i> Pedidos</a></li>
                     </ul>
                  </li>
               </ul>
            <? } ?>
