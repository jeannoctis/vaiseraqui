<div class="container-medium">
        <header data-aos="fade-up">
          ...
          <p>Eventos que vão acontecer nos próximos dias na sua região</p>
        </header>
              ...
              <div class="swiper-slide">
                <article class="card-events">
                  ...
                  <div class="cover">
                    ...
                    <div class="info">
                      <span class="tagline"><?=$evento->categoria?></span>
                      <strong class="title"><?=$evento->titulo?></strong>
                      <span class="location-1"><?=$evento->local?></span>
                      <span class="location-2"><?=$evento->cidade?></span>
                      <span class="date">
                       ...
                       if($evento->datas){
                           if(count($evento->datas) == 1) {
                               echo formataData($evento->datas[0]->data);
                           } else {
                               echo "Datas diversas";
                           }
                       }
                      ...
                      <span onclick="favoritar(<?=$evento->id?>)"  class="icon-heart <?= (in_array($evento->id, $todosFavoritos)) ? 'active' : '' ?>" data-id-heart="<?= $evento->id ?>">
