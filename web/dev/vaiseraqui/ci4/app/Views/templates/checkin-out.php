<script>
    ...
    <script>
       ...
       var array = []; 
                $(function() {           
                        from = $("#desktop-table-checkin<?=$tipo->id?>")
                        .datepicker({
                        dateFormat: 'dd/mm/yy',
                                dayNames: ['Domingo', 'Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta', 'Sábado'],
                                dayNamesMin: ['D', 'S', 'T', 'Q', 'Q', 'S', 'S', 'D'],
            ...
            return [ array.indexOf(string) == -1 ]
                    ...
                    $("#desktop-table-checkout<?=$tipo->id?>").val($("#desktop-table-checkin<?=$tipo->id?>").val());
                    $("#desktop-table-checkout<?=$tipo->id?>").removeAttr('disabled');
                   //     to.datepicker("option", "minDate", getDate(this));
           $("#desktop-table-checkout<?=$tipo->id?>").datepicker(
                    "change",
                    { minDate: new Date( FormataStringData($('#desktop-table-checkin<?=$tipo->id?>').val())) }
            );
                        }),
                        to = $("#desktop-table-checkout<?=$tipo->id?>").datepicker({
                dateFormat: 'dd/mm/yy',
               dayNames: ['Domingo', 'Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta', 'Sábado'],
               dayNamesMin: ['D', 'S', 'T', 'Q', 'Q', 'S', 'S', 'D'],
               dayNamesShort: ['Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sáb', 'Dom'],
