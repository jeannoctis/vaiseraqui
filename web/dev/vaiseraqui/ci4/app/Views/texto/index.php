                                ...
                                if ($lista) {
                                    foreach ($lista as $elemento) {
                                        ...
                                        <tr class="ui-state-default sort" rel="<?= $elemento->id ?>">
                                            ...
                                            <td>
                                                <a href="<?= PATHSITE ?>admin/<?= $tabela ?>/form/<?= encode($elemento->id) ?>/<?= arruma_url($elemento->titulo) ?>">
                                                    <div style="background-size: contain; background-position: center center; background-image:url(<?= PATHSITE ?>uploads/<?= $tabela?>/<?= $elemento->arquivo ?>); height: 120px; background-repeat: no-repeat"></div>
                                                </a>
                                            </td>
                                        </tr>
                                        <?
