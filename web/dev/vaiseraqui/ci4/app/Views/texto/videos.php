		...
		<div class="row small-spacing">
          ...
          <div class='col-xs-12 col-md-6'>            
             ...
             <div class='col-xs-12 col-md-6 text-right form-group'> 
               <a href="<?= PATHSITE ?>admin/<?= $tabela ?>/video/<?= encode($tabelaFK) ?>?tipo=<?=$get["tipo"]?>">
          ...
          <div class="table-responsive">
                ...
                <?   foreach ($lista as $elemento) { ?>
                    ...
                    <td><input type="checkbox" name="excluir[]" value="<?= $elemento->id ?>" /> </td> 
									<td> 
                  <a href="<?= PATHSITE ?>admin/<?= $tabela ?>/video/<?= encode($tabelaFK) ?>/<?= encode($elemento->id) ?>?tipo=<?=$get["tipo"]?>">
                  <?= $elemento->titulo ?>
                    </a>  
                  </td> 
                <!--  <td>
                    <a href="<?= PATHSITE ?>admin/<?= $tabela ?>/fotos/<?= encode($elemento->id) ?>">
                     Fotos <i class="menu-icon mdi mdi-camera"></i>
                    </a>       
              </td> -->
