...
<head>
	...
	<title>Home</title>
	<link rel="stylesheet" href="<?=PATHSITE?>admins/assets/styles/style.min.css">
...
<div id="single-wrapper">
	<form action="#" method='post' class="frm-single">
		<div class="inside">
			<div class="title"><strong>Uaau Digital</strong>Admin</div>
			<!-- /.title -->
			<div class="frm-title">Login</div>
			<!-- /.frm-title -->
			<div class="frm-input"><input type="text" name='usuario' placeholder="Usuário" class="frm-inp"><i class="fa fa-user frm-ico"></i></div>
			<!-- /.frm-input -->
			<div class="frm-input"><input type="password" name='senha' placeholder="Senha" class="frm-inp"><i class="fa fa-lock frm-ico"></i></div>
			<!-- /.frm-input -->
        ...
        <? if ($mensagem) { ?>
				...
				<!-- /.pull-left -->
				<div class="pull-right hidden"><a href="page-recoverpw.html" class="a-link"><i class="fa fa-unlock-alt"></i>Esqueceu a senha?</a></div>
				<!-- /.pull-right -->
			</div>
			<!-- /.clearfix -->
			<button type="submit" class="frm-submit">Login<i class="fa fa-arrow-circle-right"></i></button>
			<div class="row small-spacing hidden">
				<div class="col-sm-12">
			...
			<!-- /.row -->
			<a target="_blank" href="https://www.uaau.digital/contato/" class="a-link"><i class="fa fa-key"></i>Dúvidas? Entre em contato!</a>
			<div class="frm-footer">Uaau digital © <?=date("Y")?>.</div>
			<!-- /.footer -->
		</div>
		<!-- .inside -->
	</form>
