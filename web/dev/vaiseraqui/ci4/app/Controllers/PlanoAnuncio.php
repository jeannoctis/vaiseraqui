...
class PlanoAnuncio extends BaseController
{
   ...
   public function index()
   {
      ...
      $data['title'] = 'Planos de Anúncios';
      $data['tabela'] = "planoAnuncio";
      $data["nomeModel"] = "PlanoAnuncioModel";
