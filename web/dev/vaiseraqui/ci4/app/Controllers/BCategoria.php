...
class BCategoria extends BaseController
{
   ...
   public function __construct()
   {
      ...
      helper(['encrypt', 'text']);
      $this->model = model('App\Models\BCategoriaModel', false);
      $this->tabela = "bcategoria";
   ...
   public function index()
   {
      ...
      $data['bcategorias'] = $this->model->findAll();

      $data['title'] = 'Categorias do Blog';
      $data['tabela'] = "bcategoria";
      $data["nomeModel"] = "BCategoriaModel";
